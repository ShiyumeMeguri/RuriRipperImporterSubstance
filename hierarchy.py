...
Faithful port of the Blender addon's module of the same name, with mathutils
matrices replaced by plain numpy 4x4s (Painter has no mathutils, and world
matrices are only ever consumed numerically here).
"""
